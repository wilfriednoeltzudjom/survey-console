...
import SurveyForm from './core/SurverForm';
...
function Surveys() {
  ...
  return (
    <HomeContainer>
      <SurveysStyled>
        <SurveysHeader onOpenCreateSurveyForm={handleCreateSurvey} />

        <Divider />

        <SurveysBody surveys={surveyHelper.formatSurveysForTable(surveys)} requesting={requesting} onPrintSurvey={handlePrintSurvey} onDeleteSurvey={handleDeleteSurvey} />
      </SurveysStyled>
